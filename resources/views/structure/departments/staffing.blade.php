...
@section('title', $department->name_uz . ' - Shtat birliklari')

@section('page-title', $department->name_uz . ' - Shtat birliklari')
        ...
        <div class="col-md-8">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('structure.departments.show', $department) }}">{{ $department->name_uz }}</a></li>
...
<div class="modal fade" id="allocateStaffModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('structure.departments.allocateStaff', $department) }}" method="POST">
                @csrf
                        ...
                        <select class="form-select" name="position_id" required>
                            ...
                            @foreach($availablePositions as $pos)
                                <option value="{{ $pos->id }}">
                                    {{ $pos->name_uz }}
                                    (@switch($pos->category)
                                        @case('leadership') Rahbariyat @break
                                        @case('academic') Akademik @break
                                        @case('administrative') Ma'muriy @break
                                        @case('support') Yordamchi @break
