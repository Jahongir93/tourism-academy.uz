...
@section('title', 'Mavzuni tahrirlash')
            ...
            <form action="{{ route('subjects.topics.update', [$subject, $topic]) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('topic_type') is-invalid @enderror"
                                    ...
                                    name="topic_type"
                                    required>
                                <option value="lecture" {{ old('topic_type', $topic->topic_type) == 'lecture' ? 'selected' : '' }}>Ma'ruza</option>
                                <option value="practice" {{ old('topic_type', $topic->topic_type) == 'practice' ? 'selected' : '' }}>Amaliyot</option>
                                <option value="lab" {{ old('topic_type', $topic->topic_type) == 'lab' ? 'selected' : '' }}>Laboratoriya</option>
                                <option value="seminar" {{ old('topic_type', $topic->topic_type) == 'seminar' ? 'selected' : '' }}>Seminar</option>
                                <option value="independent" {{ old('topic_type', $topic->topic_type) == 'independent' ? 'selected' : '' }}>Mustaqil ta'lim</option>
                            </select>
                            @error('topic_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                           ...
                           id="title_uz"
                           name="title_uz"
                           value="{{ old('title_uz', $topic->title_uz) }}"
                           required>
                    @error('title_uz')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                           ...
                           id="title_ru"
                           name="title_ru"
                           value="{{ old('title_ru', $topic->title_ru) }}">
                    @error('title_ru')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description_uz') is-invalid @enderror"
                              id="description_uz"
                              name="description_uz"
                              rows="3">{{ old('description_uz', $topic->description_uz) }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number"
                                   ...
                                   id="week_number"
                                   name="week_number"
                                   value="{{ old('week_number', $topic->week_number) }}"
                                   min="1"
                                   max="52">
                            @error('week_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('is_active') is-invalid @enderror"
                                    id="is_active"
                                    name="is_active">
                                <option value="1" {{ old('is_active', $topic->is_active) == 1 ? 'selected' : '' }}>Faol</option>
                                <option value="0" {{ old('is_active', $topic->is_active) == 0 ? 'selected' : '' }}>Nofaol</option>
                            </select>
                            @error('is_active')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('learning_outcomes') is-invalid @enderror"
                              ...
                              rows="3">{{ old('learning_outcomes', $topic->learning_outcomes) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                           ...
                           id="keywords"
                           name="keywords"
                           value="{{ old('keywords', $topic->keywords) }}"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('references') is-invalid @enderror"
                              id="references"
                              name="references"
                              rows="3">{{ old('references', $topic->references) }}</textarea>
