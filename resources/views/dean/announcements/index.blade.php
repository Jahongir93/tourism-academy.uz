...
<div class="container-fluid">
            ...
            <div class="card border-0 shadow-sm bg-gradient-primary text-white">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-1"><i class="fas fa-bullhorn me-2"></i>E'lonlar</h4>
                            <p class="mb-0 opacity-75">{{ $faculty?->name ?? 'Fakultet' }} e'lonlari</p>
                        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body text-center py-5">
            <i class="fas fa-bullhorn fa-4x text-muted mb-4 opacity-50"></i>
            <h4 class="text-muted">E'lonlar moduli</h4>
