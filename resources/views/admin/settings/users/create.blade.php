...
<div class="container-fluid px-4">
    <div class="mb-4">
        <h1 class="h3 mb-0">Yangi foydalanuvchi qo'shish</h1>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.settings.users.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="row g-2 @error('roles') is-invalid @enderror" style="border:1px solid var(--c-border);border-radius:var(--r-sm);padding:12px;">
