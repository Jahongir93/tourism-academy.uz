...
@section('title', 'Yangi menyu')
@section('page-title', 'Yangi menyu qo\'shish')
                    ...
                    <form action="{{ route('admin.menu.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('label_uz') is-invalid @enderror"
                                   id="label_uz" name="label_uz" value="{{ old('label_uz') }}" required>
                            @error('label_uz')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('label_ru') is-invalid @enderror"
                                       id="label_ru" name="label_ru" value="{{ old('label_ru') }}">
                                @error('label_ru')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('label_en') is-invalid @enderror"
                                       id="label_en" name="label_en" value="{{ old('label_en') }}">
                                @error('label_en')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="open_in_new_tab" name="open_in_new_tab"
                                       value="1" {{ old('open_in_new_tab') ? 'checked' : '' }}>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <ul class="small mb-3">
                        ...
                        <li><code>fas fa-users</code> - <i class="fas fa-users"></i> Foydalanuvchilar</li>
                        <li><code>fas fa-cog</code> - <i class="fas fa-cog"></i> Sozlamalar</li>
                    </ul>

                    <h6>URL misollari:</h6>
                    <ul class="small">
                        <li><code>/about</code> - Ichki sahifa</li>
                        <li><code>/contact</code> - Aloqa sahifasi</li>
                        <li><code>https://example.com</code> - Tashqi havola</li>
                    </ul>
                </div>
            </div>
        </div>
