        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('teacher.topics.show', [$subject->id, $topic->id]) }}">{{ $topic->title }}</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('teacher.topics.update', [$subject->id, $topic->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror"
                                      id="content"
                                      name="content"
                                      rows="10">{{ old('content', $topic->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                           ...
                                           id="duration_hours"
                                           name="duration_hours"
                                           value="{{ old('duration_hours', $topic->duration_hours) }}"
                                           step="0.5"
                                           min="0">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Yangilash
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">Mavzu Haqida</h6>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <strong>Fan:</strong> {{ $subject->name }}
                        </li>
                        <li class="mb-2">
                            <strong>Yaratilgan:</strong> {{ $topic->created_at->format('d.m.Y H:i') }}
                        </li>
                        <li class="mb-2">
                            <strong>Yangilangan:</strong> {{ $topic->updated_at->format('d.m.Y H:i') }}
                        </li>
                        <li>
                            <strong>Resurslar:</strong> {{ $topic->resources()->count() }} ta
                        </li>
                    </ul>
                </div>
            </div>
