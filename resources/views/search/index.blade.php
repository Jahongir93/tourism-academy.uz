                    ...
                    @foreach($results['news'] as $news)
                        <div class="result-card">
                            <a href="{{ route('news.show', $news->slug) }}">
                                <div class="result-image" style="background-image: url('{{ $news->featured_image ? asset($news->featured_image) : 'https://via.placeholder.com/200x150' }}')"></div>
                    ...
                    @foreach($results['events'] as $event)
                        <div class="result-card">
                            <a href="{{ route('news.show', $event->slug ?? $event->id) }}">
                                <div class="result-image" style="background-image: url('{{ $event->featured_image ? asset('storage/' . $event->featured_image) : 'https://via.placeholder.com/200x150' }}')"></div>
                                <div class="result-content">
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="result-card">
                                    <a href="{{ route('teachers') }}#teacher-{{ $teacher->id }}" style="flex-direction: column;">
                                        <div class="result-image" style="height: 200px; background-image: url('{{ $teacher->photo_url ?: 'https://via.placeholder.com/200x200?text=' . urlencode(mb_substr($teacher->first_name, 0, 1) . mb_substr($teacher->last_name, 0, 1)) }}')"></div>
