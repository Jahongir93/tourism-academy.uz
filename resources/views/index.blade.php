        ...
        <div class="swiper heroSwiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide relative">
                    <div class="h-[600px] bg-cover bg-center" style="background-image: url('https://picsum.photos/1920/600?random=1');">
                ...
                <!-- Slide 2 -->
                <div class="swiper-slide relative">
                    <div class="h-[600px] bg-cover bg-center" style="background-image: url('https://picsum.photos/1920/600?random=2');">
                        <div class="absolute inset-0 bg-black bg-opacity-50"></div>
                        <div class="relative h-full flex items-center">
                            <div class="container mx-auto px-4">
                                <div class="max-w-3xl text-white hero-text">
                ...
                <!-- Slide 3 -->
                <div class="swiper-slide relative">
                    <div class="h-[600px] bg-cover bg-center" style="background-image: url('https://picsum.photos/1920/600?random=3');">
                        <div class="absolute inset-0 bg-black bg-opacity-50"></div>
                        <div class="relative h-full flex items-center">
                            <div class="container mx-auto px-4">
                                <div class="max-w-3xl text-white hero-text">
