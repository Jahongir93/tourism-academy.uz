...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasColumn('students', 'first_name')) DB::statement('ALTER TABLE students MODIFY COLUMN first_name VARCHAR(255) NULL');
        if (Schema::hasColumn('students', 'last_name')) DB::statement('ALTER TABLE students MODIFY COLUMN last_name VARCHAR(255) NULL');
        if (Schema::hasColumn('students', 'middle_name')) DB::statement('ALTER TABLE students MODIFY COLUMN middle_name VARCHAR(255) NULL');
        if (Schema::hasColumn('students', 'full_name')) DB::statement('ALTER TABLE students MODIFY COLUMN full_name VARCHAR(255) NULL');
        if (Schema::hasColumn('students', 'email')) DB::statement('ALTER TABLE students MODIFY COLUMN email VARCHAR(255) NULL');
        if (Schema::hasColumn('students', 'phone')) DB::statement('ALTER TABLE students MODIFY COLUMN phone VARCHAR(255) NULL');
        ...
        if (Schema::hasColumn('students', 'photo_url')) DB::statement('ALTER TABLE students MODIFY COLUMN photo_url VARCHAR(255) NULL');
    }
